...
class ParticleFilter:
    ...
    def move(self, v: float, w: float, override_dt: float = None) -> None:
        """
        ...
        """
        dt = (
            override_dt if override_dt is not None else self._dt
        ...
        for i, particle in enumerate(self._particles):
            ...
            x += noise_v * math.cos(theta) * dt
            y += noise_v * math.sin(theta) * dt
