...
from amr_msgs.msg import PoseStamped as AmrPoseStamped # Custom message type for pose
...
class PurePursuitNode(LifecycleNode):
    ...
    def _compute_commands_callback(self, pose_msg: AmrPoseStamped) -> None:
        """
    ...
    def _publish_velocity_commands(self, v: float, w: float) -> None:
        """
        Publishes velocity commands as a Twist message.
