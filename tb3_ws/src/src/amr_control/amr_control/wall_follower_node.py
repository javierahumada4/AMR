...
class WallFollowerNode(LifecycleNode):
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        try:
            ...
            self._subscribers.append(
                message_filters.Subscriber(self, WallFollowerActive, "/activateFollower", qos_profile=10)
            )
    ...
    def _compute_commands_callback(
        self, odom_msg: Odometry, scan_msg: LaserScan, pose_msg: PoseStamped = PoseStamped(), active_msg: WallFollowerActive = WallFollowerActive()
    ):
        ...
        if self.active or WallFollowerActive.active:
