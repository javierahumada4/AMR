...
class WallFollower:
    ...
    def __init__(self, dt: float) -> None:
        ...
        self.stop_distance: float = (
            0.2  # Minimum distance to stop before an obstacle [m]
        )
        ...
        self.w_control: float = (
            0.2  # Maximum angular velocity for wall following [rad/s]
        )
        self.w_turn: float = 3.0  # Angular velocity for turning [rad/s]
    ...
    def compute_commands(
        ...
        front: List[float] = list(z_scan[0:20]) + list(z_scan[-20:])  # Front sector
